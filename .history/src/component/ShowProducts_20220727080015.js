...
const ShowProducts = ({filter, setFilter,data}) => {
  return (
    ...
    <div className='buttons d-flex justify-content-center mb-5 pb-5'>
        ...
        <button className='btn btn-outline-dark me-2' onClick={()=>setFilter(data)}>Jewelry's clothing</button>
        <button className='btn btn-outline-dark me-2'onClick={()=>setFilter(data)}>Electronics</button>
    </div>
    {filter.map((product)=>{
        return(
            <>
