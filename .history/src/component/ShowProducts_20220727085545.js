...
const ShowProducts = ({filter, filterProductFilter,data}) => {
  return (
    ...
    <div className='buttons d-flex justify-content-center mb-5 pb-5'>
        ...
        <button className='btn btn-outline-dark me-2' onClick={()=>filterProduct("women")}>Women's clothing</button>
        <button className='btn btn-outline-dark me-2' onClick={()=>filterProduct(jeweler)}>Jewelry's clothing</button>
